...
use crate::common::{
    exec_cmd, failed_message, TestProgress, TomlBuilder, CSBOOKS_REPO, DEFAULT_BRANCH, SBERT_REPO,
};
...
fn cli_sync_simple_tracking_invalid() -> MgitResult<()> {
    let path = env::current_dir()
        ...
        .join("target")
        .join("tmp")
        .join("test_sync_simple_tracking_invalid");
    let input_path = path.to_str().unwrap();
...
fn cli_sync_stash_tracking_invalid() -> MgitResult<()> {
    let path = env::current_dir()
        ...
        .join("target")
        .join("tmp")
        .join("test_sync_stash_tracking_invalid");
    let input_path = path.to_str().unwrap();
...
fn cli_sync_simple_invalid_path() -> MgitResult<()> {
    let path = env::current_dir()
        ...
        .join("target")
        .join("tmp")
        .join("test_sync_simple_invalid_path");
...
fn cli_sync_stash_invalid_path() -> MgitResult<()> {
    let path = env::current_dir()
        ...
        .join("target")
        .join("tmp")
        .join("test_sync_stash_invalid_path");
...
fn cli_sync_hard_invalid_path() -> MgitResult<()> {
    let path = env::current_dir()
        ...
        .join("target")
        .join("tmp")
        .join("test_sync_hard_invalid_path");
...
fn cli_sync_simple_repo_invalid() -> MgitResult<()> {
    let path = env::current_dir()
        ...
        .join("target")
        .join("tmp")
        .join("test_sync_simple_repo_invalid");
...
fn cli_sync_checkout_invalid_path() -> MgitResult<()> {
    let path = env::current_dir()
        ...
        .join("target")
        .join("tmp")
        .join("test_sync_checkout_invalid_path");
    let input_path = path.to_str().unwrap();
...
fn cli_sync_checkout_symple() -> MgitResult<()> {
    let path = env::current_dir()
        ...
        .join("target")
        .join("tmp")
        .join("test_sync_checkout_symple");
    let input_path = path.to_str().unwrap();
...
fn cli_sync_checkout_with_conflict() -> MgitResult<()> {
    let path = env::current_dir()
        ...
        .join("target")
        .join("tmp")
        .join("test_sync_checkout_with_conflict");
    let input_path = path.to_str().unwrap();
...
fn cli_sync_checkout_symple2() -> MgitResult<()> {
    let path = env::current_dir()
        ...
        .join("target")
        .join("tmp")
        .join("test_sync_checkout_symple2");
    let input_path = path.to_str().unwrap();
