...
use crate::ui::components::create_layout_job;
...
impl ErrorWindow {
    ...
    pub fn new_retryable(content: String) -> Self {
        Self {
            content,
            retryable: true,
            retry_requested: false,
    ...
    pub(crate) fn take_retry_requested(&mut self) -> bool {
        let v = self.retry_requested;
...
impl super::View for ErrorWindow {
    fn ui(&mut self, ui: &mut egui::Ui) {
        ...
        ui.with_layout(egui::Layout::top_down(egui::Align::LEFT), |ui| {
            ...
            if self.retryable && ui.button("retry").clicked() {
