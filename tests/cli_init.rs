...
fn cli_init_with_path_only() {
    let path = env::current_dir().unwrap().join("target/tmp/test_init1");
...
fn cli_init_with_path_force1() {
    let path = env::current_dir().unwrap().join("target/tmp/test_init2");
...
fn cli_init_with_path_force2() {
    let path = env::current_dir().unwrap().join("target/tmp/test_init3");
...
fn cli_init_with_path_force3() {
    let path = env::current_dir().unwrap().join("target/tmp/test_init4");
